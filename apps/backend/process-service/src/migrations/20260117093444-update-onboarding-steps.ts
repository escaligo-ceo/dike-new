    ...
    if (hasStatusColumn.length > 0) {
      ...
      await queryRunner.query(`
        ...
        SET step_temp = CASE
          ...
          WHEN status = 'USER_CREATED' THEN 'USER_CREATION'::onboarding_step_enum
          WHEN status = 'PROFILE_CREATED' THEN 'PROFILE_CREATION'::onboarding_step_enum
          WHEN status = 'TENANT_CREATED' THEN 'TENANT_CREATION'::onboarding_step_enum
          WHEN status = 'TEAM_CREATED' THEN 'TEAM_CREATION'::onboarding_step_enum
          WHEN status = 'OFFICE_CREATED' THEN 'OFFICE_CREATION'::onboarding_step_enum
    ...
    if (hasStepColumn.length > 0) {
      ...
      await queryRunner.query(`
        ...
        SET status_temp = CASE
          ...
          WHEN step = 'USER_CREATION' THEN 'USER_CREATED'
          WHEN step = 'PROFILE_CREATION' THEN 'PROFILE_CREATED'
          WHEN step = 'TENANT_CREATION' THEN 'TENANT_CREATED'
          WHEN step = 'TEAM_CREATION' THEN 'TEAM_CREATED'
          WHEN step = 'OFFICE_CREATION' THEN 'OFFICE_CREATED'
